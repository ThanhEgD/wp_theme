                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo home_url('/car-search'); ?>" method="GET">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="keyword" placeholder="Type a keyword" class="form-control" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword']: ''; ?>">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="price_below" class="form-select">
                                    <?php for ($i = 0; $i < 210000; $i+=10000): ?>
                                        ...
                                        <option
                                                <?php if (isset($_GET['price_below']) && ($_GET['price_above'] == $i)): ?>
                                                    selected
                        ...
                        <button type="submit" class="btn btn-success btn-lg btn-block mb-3">Search</button>
